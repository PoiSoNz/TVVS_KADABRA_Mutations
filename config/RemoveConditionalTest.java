...
public class RemoveConditionalTest {
    public void calls() {
        ...
        if (this.boxedBooleanMethod()) {
            if ((stringMethod()) == "teste") {
                ...
                if (((this.intMethod(10, 11)) * 2) < (this.intMethod(4, 12))) {
                    boxedBooleanMethod();
                }else
                    if ((this.intMethod(10, 11)) == 4) {
                        boxedBooleanMethod();
    ...
    public RemoveConditionalTest.TestObjectClass objectMethod() {
        return new RemoveConditionalTest.TestObjectClass();
    }
